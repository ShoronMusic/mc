...
| **週次: m8 JSON → mc DB** | `scripts/run-music8-weekly-sync.ps1`・`diff-music8-sync-plan.ts`・`apply-music8-sync-plan.ts` | **手順**: `docs/00-music8-weekly-mc-sync.md`（PowerShell・`-SkipDryRun`・ログ） |
