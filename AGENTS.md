...
| **曲マスタ正本（Music8 共通）** | `docs/sql/music8-catalog-extension.sql`・`/admin/songs/new`・`scripts/export-music8-json-from-supabase.ts`・`scripts/import-music8-wp-catalog.ts` | 書き込みは Supabase。公開 Music8 は JSON キャッシュ（`E:\m8`）。仕様: `docs/supabase-music8-catalog-tables.md` |
