...
| Music8 アーティスト JSON → `artists` | `src/lib/music8-artist-import.ts`・`scripts/import-music8-artists-bulk.ts`・`POST /api/admin/artist-master-import-json` | 計画: `docs/music8-artist-import-and-integration-plan.md`。**自宅 PC 引き継ぎ**: `docs/music8-artist-import-handoff.md`（`C:\Users\maeha\json`）。SQL: `docs/supabase-songs-and-performances-tables.md`「アーティスト m8 整合」 |
