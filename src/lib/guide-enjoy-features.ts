...
export const GUIDE_ENJOY_ORIGINAL_AIS = {
  ...
  roles: [
    ...
    },
    {
      id: 'ai-agent',
      title: 'AI エージェント',
      tagline: 'ユーザーと同じ立場で選曲に参加し、選曲への短いコメントで場を盛り上げる AI',
      description:
        '人間の参加者と同じように、順番が回ってきたら曲を選ぶこともあります。選曲が始まったら短い褒めを出すことがあり、参加者が少ないときの相棒としても部屋の空気をやわらげます。参加者同士の雑談には割り込みません。キャラクター性のある「一緒に楽しむ仲間」です。',
...
export const GUIDE_ENJOY_TAB_CATEGORIES: GuideEnjoyCategory[] = [
  ...
  },
  {
    ...
    tabLabel: 'エージェント',
    lead: 'ユーザーと同じ立場で選曲に参加し、選曲への短いコメントで場を盛り上げる AI エージェントです。',
    features: [
      {
      ...
      },
      {
        title: '選曲への短いコメント',
        description:
          '人間の参加者が選んだ曲が流れ始めたとき、選曲者への短い褒めを出すことがあります。参加者同士の雑談やニックネーム談義には割り込みません。',
        badge: 'beta',
      },
      {
