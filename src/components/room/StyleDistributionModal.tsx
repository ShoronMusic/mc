...
export default function StyleDistributionModal({ roomId, open, onClose }: StyleDistributionModalProps) {
  ...
  const orderedEntries = (() => {
    ...
    for (const s of SONG_STYLE_OPTIONS) {
    ...
    >
      ...
      >
        <div className="mb-3 flex items-center justify-between gap-2">
          <h2 id="style-dist-title" className="text-base font-semibold text-white">
            スタイル分布
          </h2>
          <button
            type="button"
        ...
        {loading ? (
          ...
          <div className="max-h-[50vh] space-y-2 overflow-auto pr-1">
            ...
            {orderedEntries.map(([label, n]) => {
              ...
              const color = STYLE_BAR_COLORS[label] ?? '#78909c';
              return (
