...
import {
  applyWesternArtistPlaylistItems,
...
/**
 * POST: 洋楽アーティスト用 — プレイリスト曲を songs / song_videos へ投入。
 */
export async function POST(request: Request) {
  ...
  try {
    const results = await applyWesternArtistPlaylistItems(admin, items, {
      dryRun,
      forceAllow,
      skipExisting,
    ...
    console.error('[admin/western-artist-profile/playlist-apply]', e);
